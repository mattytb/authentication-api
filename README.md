[![Build Status](https://travis-ci.org/esharmony/authentication-api.svg?branch=master)](https://travis-ci.org/esharmony/authentication-api)
...
The Web Client which uses this API can be found here: https://whispering-beach-82467.herokuapp.com/ - Because it is running on free heroku dynos at the moment https://devcenter.heroku.com/articles/free-dyno-hours the first request maybe slow and as the dynos will sleep after 30 mins of inactivity
